defmodule MeshumWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: MeshumWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MeshumWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MeshumWeb.Gettext, "errors", msg, opts)
    end
  end
