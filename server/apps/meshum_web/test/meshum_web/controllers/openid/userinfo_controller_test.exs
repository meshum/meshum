defmodule MeshumWeb.Controllers.Openid.UserinfoControllerTest do
  ...
  alias MeshumWeb.Controllers.Openid.UserinfoController

  setup :verify_on_exit!

  describe "MeshumWeb.Controllers.Openid.UserinfoController.userinfo/2" do
