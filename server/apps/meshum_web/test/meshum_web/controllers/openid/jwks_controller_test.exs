defmodule MeshumWeb.Controllers.Openid.JwksControllerTest do
  use MeshumWeb.ConnCase, async: true

  import Mox

  alias MeshumWeb.Controllers.Openid.JwksController

  setup :verify_on_exit!

  describe "MeshumWeb.Controllers.Openid.JwksController.jwks_index/2" do
