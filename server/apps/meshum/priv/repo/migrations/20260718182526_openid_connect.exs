defmodule Meshum.Repo.Migrations.OpenidConnect do
  use Ecto.Migration

  # Vendored from Boruta.Migrations.OpenidConnect (boruta ~> 2.3).
  # `meshum` does not depend on `boruta` (see docs/architecture.md); this is
  # the exact macro-expansion of `use Boruta.Migrations.OpenidConnect`,
