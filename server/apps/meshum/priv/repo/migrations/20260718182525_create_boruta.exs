defmodule Meshum.Repo.Migrations.CreateBoruta do
  use Ecto.Migration

  # Vendored from Boruta.Migrations.CreateBoruta (boruta ~> 2.3).
  # `meshum` does not depend on `boruta` (see docs/architecture.md); this is
  # the exact macro-expansion of `use Boruta.Migrations.CreateBoruta`,
